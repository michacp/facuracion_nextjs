// src/features/productos/components/NewProveedorModal/index.tsx
"use client";

import { useNewProveedor } from "../../hooks/useNewProveedor";
import type { NewProveedorResult } from "../../types/newProveedorModal.types";
...
export function NewProveedorModal({ onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="su-surface-lg rounded-3xl w-full max-w-lg flex flex-col
